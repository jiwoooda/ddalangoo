...
#  - "등록"은 뺐다(WON-38 Unit 4): "등록된 배송지/주소"는 관형형('-된')이라 등록이
#    끝난 상태(=조회, what)를 가리키는데 substring "등록"이 걸려 procedure 로 오분류됐다.
#    실제 절차 질문("카드는 어떻게 등록해요?", "배송지 등록 어떻게 해요")은 전부
#    "어떻게/어디서" 등 다른 표시어를 함께 달고 오므로 손실 없음.
_PROCEDURE_MARKERS: tuple[str, ...] = (
    "어떻게", "어디서", "어디다", "어디에", "어디", "방법", "절차",
    "신청", "가입", "입력", "적어", "적나", "기재", "바꿔", "바꾸", "변경",
)
