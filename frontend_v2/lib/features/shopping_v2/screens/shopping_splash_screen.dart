...
class _ShoppingSplashScreenState extends State<ShoppingSplashScreen> {
  ...
  void initState() {
    super.initState();
    debugPrint('[ShoppingSplashScreen] initState');
    _navigate();
  }

  Future<void> _navigate() async {
    debugPrint('[ShoppingSplashScreen] waiting 2s before auto navigation');
    await Future<void>.delayed(const Duration(seconds: 2));
    if (!mounted) {
      debugPrint('[ShoppingSplashScreen] navigation skipped because unmounted');
      return;
    }
    debugPrint('[ShoppingSplashScreen] pushReplacementNamed(/shopping-v2)');
    Navigator.of(context).pushReplacementNamed('/shopping-v2');
  }

  @override
  Widget build(BuildContext context) {
    debugPrint('[ShoppingSplashScreen] build');
