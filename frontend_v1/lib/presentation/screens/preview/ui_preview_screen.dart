...
class UiPreviewScreen extends StatelessWidget {
      ...
      body: ListView(
        ...
        children: [
          ...
          _PreviewTile(
            ...
            onTap: () =>
                _openPage(context, const _ShoppingJourneyPreviewScreen()),
          ),
  ...
  static void _openCallPreview(
    BuildContext context,
    _CallPreviewScenario scenario,
  ) {
        ...
        builder: (_) => ChangeNotifierProvider(
          create: (_) => CallProvider()
            ..loadPreviewState(
              ...
              assistantPresentationMessage:
                  scenario.assistantPresentationMessage,
            ),
          child: const CallScreen(previewMode: true, autoStart: false),
        ),
      ),
    );
  }
...
final AgentResponse _watermelonRecommendationResponse = AgentResponse.fromJson({
  ...
  'assistantMessage': 'CJ 신선한 고당도 수박 1kg, 가격은 9,900원이에요. 구매할까요?',
  'recommendations': [
    {
...
final _CallPreviewScenario _journeyRecommendationScenario =
...
final _CallPreviewScenario _journeyQuantityQuestionScenario =
    _CallPreviewScenario(
      title: '수량 질문',
      ...
      response: AgentResponse.fromJson({
        ...
        'recommendations': _watermelonRecommendationResponse.recommendations
            ...
            .toList(),
        'selectedProduct': _watermelonRecommendationResponse.selectedProduct,
        'pendingConfirmation': {'type': 'quantity', 'message': '몇 개 구매할까요?'},
      }),
      messages: _messagesWithProductCard(
        items: [
          const _PreviewMessage('김영희님, 무엇을 구매하고 싶으신가요?', isUser: false),
...
final _CallPreviewScenario _journeyAddressConfirmScenario =
    _CallPreviewScenario(
      title: '배송지 확인',
...
final List<_CallPreviewScenario> _callScenarios = [
  ...
  _CallPreviewScenario(
    ...
    isAwaitingAssistantPresentation: true,
    assistantPresentationMessage: '김영희님을 위한 맞춤 상품을 정리하고 있어요.',
    messages: _messages([const _PreviewMessage('달콤한 수박을 찾고 싶어', isUser: true)]),
  ),
  _CallPreviewScenario(
