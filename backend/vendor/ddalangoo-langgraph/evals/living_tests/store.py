...
SCOPES: dict[str, list[str]] = {
    "unit": ["intent_agent", "context_agent", "product_agent", "response_agent", "smalltalk_agent", "reorder_agent", "payment_agent", "respond", "fallback_orchestrator", "turn_outcome_guard", "transition_failure", "route"],
