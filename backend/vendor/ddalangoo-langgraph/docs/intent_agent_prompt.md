...
Pending action: null
{
  ...
  "clarification_reason": null,
  "confidence": 0.9,
  "immediate_response": "이전에 사신 딸기를 찾아볼게요."
}

User input: 이거 배송 빨라?
Stage: product_confirming
Pending action: {"type": "product_confirm"}
{
  "intent": "ask",
  "keywords": [],
  "exclude_keywords": [],
  ...
  "clarification_reason": null,
  "confidence": 0.9,
  "immediate_response": "배송 정보를 확인할게요."
}

User input: 삼성 말고 LG로 보여줘
Stage: product_confirming
Pending action: {"type": "product_confirm"}
{
  "intent": "refine",
  ...
  "clarification_reason": null,
  "confidence": 0.9,
  "immediate_response": "LG 제품으로 다시 볼게요."
}

User input: 빨간색으로
Stage: payment_processing
Pending action: {"type": "option_select"}
{
  ...
  "target_platforms": [],
  "override_platform": null,
  "current_option_value": "빨강",
  "address_text": null,
  "needs_clarification": false,
  "clarification_reason": null,
  "confidence": 0.9,
  "immediate_response": "빨간색으로 선택할게요."
}
...
Pending action: null
{
  ...
  "clarification_reason": "확인할 대상이 없음",
  "confidence": 0.3,
  "immediate_response": "어떤 내용을 말씀하시는 건가요?"
}

User input: 그거 있잖아 저번에 산 그거
Stage: idle
Pending action: null
{
  "intent": "unclear",
  ...
  "address_text": null,
  "needs_clarification": true,
  "clarification_reason": "어떤 상품인지 알 수 없음",
  "confidence": 0.3,
  "immediate_response": "어떤 상품 말씀이세요?"
}

User input: 주소 바꿔줘 서울 강남구로
Stage: payment_processing
Pending action: {"type": "address_confirm"}
{
