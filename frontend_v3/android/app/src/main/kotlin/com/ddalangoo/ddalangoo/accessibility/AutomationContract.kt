...
object AutomationContract {
    ...
    object ResultStatus {
        ...
        const val REQUIRES_USER_ACTION = "requires_user_action"
 ...
 *
 * pendingConfirmation은 사용자 확인 대기, uiCommand는 앱 화면 제어 힌트에 가깝다.
 * 반면 AutomationTask는 외부 쇼핑 앱에서 수행해야 하는 자동화 작업 하나를 뜻한다.
 */
